...
void dataRankerHashMap(Heap& substanceRates, HashMap& test, bool marijuana, bool drug, bool alcohol, bool young, bool youngAdult, bool adult) {
...
int main() {
	...
	insertData(test, "drugs.csv","Alabama");
	...
	dataRankerHashMap(substanceRates, test, marijuana, drug, alcohol, young, youngAdult, adult);
